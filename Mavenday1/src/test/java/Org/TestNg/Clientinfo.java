...
class Singleton{
		...
		@Parameters({"url"})
		@Test(priority=1)
		public void launchBrowser(String urls) {
		...
		@Test(priority=3)
		public void loginLaunch(String username,String password ) {
		...
		@Test(priority=5)
		public void searchHotels(String datepick_out,String adult_room,String child_room) {
		...
		@Test(priority=7)
		public  void bookingHotel(String first_name,String last_name) {
		...
		@Test(priority=8)
		public  void bookingHotel1(String address,String cc_num,String cc_type) {   
...
public class Clientinfo {
	...
	Singleton x=Singleton.objsingleton();
	x.launchBrowser("https://adactinhotelapp.com/");
	x.maximum();
	x.loginLaunch("Jamesgosling", "Jamesgosling@50");
	x.searchHotel("London", "Hotel Sunshine", "2", "30/09/2022");
	x.searchHotels("01/10/2022", "2","1");
	x.bookingHotel("jona", "sasi");
	x.alert();
